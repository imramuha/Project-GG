<template>
    <div class="privacy">
        ...
        <p>
            <sub>Last updated July 03, 2020</sub>
        </p>

        <p>Thank you for choosing to be part of our community at Project-GG (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at admin@projectgg.com.</p>

        <p>When you visit our website http://www.projectgg.com (the "Website"), and more generally, use any of our services (the "Services", which include the Website), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.</p>
        ...
        <p>
            <b>In Short: We collect information that you provide to us.</b>
        </p>
        ...
        <p>Personal Information Provided by You. We collect email addresses; usernames; passwords; and other similar information.</p>
        <p>
            <b>All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.</b>
        </p>
        ...
        <p>
            <b>More specifically, we may need to process your data or share your personal information in the following situations:</b>
        </p>
        ...
        <p>If you have questions or comments about your privacy rights, you may email us at admin@projectgg.com.</p>

        <p>
            <b>
                <sup>Account Information</sup>
            </b>
        </p>

        <p>
            <b>If you would at any time like to review or change the information in your account or terminate your account, you can:</b>
        </p>
        <ul>
        ...
        <p>
            <b>
                <sup>Opting out of email marketing:</sup> You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list – however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may:
            </b>
        </p>
        <ul>
        ...
        <h2>7. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>

        <p>
            <b>In Short: Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.</b>
        </p>
        ...
        <p>
            <b>In Short: Yes, we will update this notice as necessary to stay compliant with relevant laws.</b>
        </p>
        ...
        <p>
            <b>If you have questions or comments about this notice, you may email us at admin@projectgg.com or by post to:</b>
        </p>
        <p>Project-GG</p>
        <p>Project</p>
        <p>GG</p>
        ...
        <p>
            Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: contact: admin@projectgg.com. We will respond to your request within 30 days.
            <sub>This privacy policy was created using Termly’s Privacy Policy Generator.</sub>
        </p>
    </div>
</template>
