<template>
  <div class="privacy">
    <div class="content">
      ...
      <p>
        Thank you for choosing to be part of our community at Project-GG
      ...
      <p>
        When you visit our website http://www.projectgg.com (the "Website"), and
      ...
      <h2 id="useinformation">2. HOW DO WE USE YOUR INFORMATION?</h2>

      <p>
        <b
          >In Short: We process your information for purposes based on
          legitimate business interests, the fulfillment of our contract with
          you, compliance with our legal obligations, and/or your consent.</b
        >
      </p>
      ...
      <blockquote>
        <ul>
          ...
          <li>
            ...
            please contact us at admin@projectgg.com and be sure to include your
      ...
      <p>
        <b
          ...
          fulfill business obligations.</b
        >
      </p>
      <p>
      ...
      <p>
        <b
          ...
          personal information in the following situations:</b
        >
      </p>
      ...
      <blockquote>
        ...
        another company. Other Users. When you share personal information (for
        example, by posting comments, contributions or other content to the
        Website) or otherwise interact with public areas of the Website, such
      ...
      <h2 id="periodinformation">4. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
      ...
      <h2 id="privacy">5. WHAT ARE YOUR PRIVACY</h2>
      ...
      <p>
        ...
        email us at admin@projectgg.com.
      </p>
      ...
      <p>
        <b
          ...
          your account or terminate your account, you can:</b
        >
      </p>
      <ul>
      ...
      <p>
        <b>
          <sup>Opting out of email marketing:</sup> You can unsubscribe from our
      ...
      <h2 id="features">6. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
      ...
      <h2 id="notice">7. DO WE MAKE UPDATES TO THIS NOTICE?</h2>

      <p>
        <b
          >In Short: Yes, we will update this notice as necessary to stay
          compliant with relevant laws.</b
        >
      </p>
      ...
      <h2 id="data">
        9. How can you review, update or delete data we collect from you?
      </h2>
      <p>
