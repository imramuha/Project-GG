<template>
  <div class="terms">
    <div class="content">
      ...
      <h2 id="property">INTELLECTUAL PROPERTY RIGHTS</h2>
      ...
      <h2 id="representation">USER REPRESENTATIONS</h2>
      ...
      <h2 id="contributions">USER GENERATED CONTRIBUTIONS</h2>
      ...
      <h2 id="license">CONTRIBUTION LICENSE</h2>
      ...
      <h2 id="management">SITE MANAGEMENT</h2>
      ...
      <h2 id="termination">TERM AND TERMINATION</h2>
      ...
      <h2 id="modifications">MODIFICATIONS AND INTERRUPTIONS</h2>
    ...
    <div class="toc">
      ...
      <ol>
        ...
        <li><a href="#property">INTELLECTUAL PROPERTY RIGHTS </a></li>

        <li>
          <a href="#representation">USER REPRESENTATIONS </a>
        </li>
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              <a href="#management">SITE MANAGEMENT </a>
            </li>
