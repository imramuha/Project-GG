<template>
  <div class="terms">
    TERMS OF USE Last updated 03/07/2020 AGREEMENT TO TERMS These Terms of Use
    constitute a legally binding agreement made between you, whether personally
    or on behalf of an entity (“you”) and __________ ("Company", “we”, “us”, or
    “our”), concerning your access to and use of the __________ website as well
    ...
    AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions
    ...
    sole discretion, to make changes or modifications to these Terms of Use at
    ...
    periodically review these Terms of Use to stay informed of updates. You will
    ...
    the Site after the date such revised Terms of Use are posted. The
    ...
    software, website designs, audio, video, text, photographs, and graphics on
    the Site (collectively, the “Content”) and the trademarks, service marks,
    and logos contained therein (the “Marks”) are owned or controlled by us or
    ...
    express prior written permission. Provided that you are eligible to use the
    ...
    Content and the Marks. USER REPRESENTATIONS By using the Site, you represent
    and warrant that: (1) you have the legal capacity and you agree to comply
    with these Terms of Use; (2) you are not a minor in the jurisdiction in
    ...
    thereof). PROHIBITED ACTIVITIES You may not access or use the Site for any
    ...
    agree not to: USER GENERATED CONTRIBUTIONS The Site does not offer users to
    ...
    available any Contributions, you thereby represent and warrant that: 1. The
    ...
    forms of solicitation. 6. Your Contributions are not obscene, lewd,
    lascivious, filthy, violent, harassing, libelous, slanderous, or otherwise
    objectionable (as determined by us). 7. Your Contributions do not ridicule,
    mock, disparage, intimidate, or abuse anyone. 8. Your Contributions do not
    advocate the violent overthrow of any government or incite, encourage, or
    threaten physical harm against another. 9. Your Contributions do not violate
    any applicable law, regulation, or rule. 10. Your Contributions do not
    violate the privacy or publicity rights of any third party. 11. Your
    ...
    sexual or violent manner. 12. Your Contributions do not violate any
    applicable law concerning child pornography, or otherwise intended to
    protect the health or well-being of minors; 13. Your Contributions do not
    include any offensive comments that are connected to race, national origin,
    gender, sexual preference, or physical handicap. 14. Your Contributions do
    ...
    Site. CONTRIBUTION LICENSE You and the Site agree that we may access, store,
    ...
    settings). By submitting suggestions or other feedback regarding the Site,
    you agree that we can use and share such feedback for any purpose without
    compensation to you. We do not assert any ownership over your Contributions.
    ...
    action against us regarding your Contributions. SUBMISSIONS You acknowledge
    and agree that any questions, comments, suggestions, ideas, feedback, or
    other information regarding the Site ("Submissions") provided by you to us
    ...
    or misappropriation of any proprietary right in your Submissions. SITE
    MANAGEMENT We reserve the right, but not the obligation, to: (1) monitor the
    Site for violations of these Terms of Use; (2) take appropriate legal action
    ...
    property and to facilitate the proper functioning of the Site. TERM AND
    TERMINATION These Terms of Use shall remain in full force and effect while
    ...
    injunctive redress. MODIFICATIONS AND INTERRUPTIONS We reserve the right to
    ...
    to update any information on our Site. We also reserve the right to modify
    or discontinue all or part of the Site without notice at any time. We will
    not be liable to you or any third party for any modification, price change,
    suspension, or discontinuance of the Site. We cannot guarantee the Site will
    ...
    update, suspend, discontinue, or otherwise modify the Site at any time or
    ...
    connection therewith. GOVERNING LAW These Terms shall be governed by and
    defined following the laws of __________. __________ and yourself
    irrevocably consent that the courts of __________ shall have exclusive
    jurisdiction to resolve any dispute which may arise in connection with these
    terms. DISPUTE RESOLUTION Binding Arbitration Any dispute arising out of or
    ...
    __________. The seat, or legal place, of arbitration shall be __________.
    The language of the proceedings shall be __________. The governing law of
    the contract shall be the substantive law of __________. Restrictions The
    ...
    of the general public or any other persons. Exceptions to Arbitration The
    ...
    CORRECTIONS There may be information on the Site that contains typographical
    ...
    information on the Site at any time, without prior notice. DISCLAIMER THE
    ...
    APPROPRIATE. LIMITATIONS OF LIABILITY IN NO EVENT WILL WE OR OUR DIRECTORS,
    ...
    LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR __________. CERTAIN US
    ...
    APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS. INDEMNIFICATION You agree
    ...
    due to or arising out of: (1) use of the Site; (2) breach of these Terms of
    ...
    MISCELLANEOUS These Terms of Use and any policies or operating rules posted
    by us on the Site or in respect to the Site constitute the entire agreement
    ...
    by the parties hereto to execute these Terms of Use. CONTACT US In order to
    resolve a complaint regarding the Site or to receive further information
    regarding use of the Site, please contact us at: __________ __________
    Phone: __________ __________ These terms of use were created using Termly’s
